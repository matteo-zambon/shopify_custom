const GTM_ID = 'PWR42QPW'; //from settings tag
const GTM_URL = 'https://sgtm.fgm04.it'; //from settings tag
...
function loadGTM() {
  (function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s);j.async=true;j.src="https://sgtm.fgm04.it/Hserxknavc.js?"+i;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','p=aWQ9R1RNLVBXUjQyUVBX&apiKey=d41d8cd9');
}
